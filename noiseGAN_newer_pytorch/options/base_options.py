...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot_A', required=True, help='path to images of domain-A')
        parser.add_argument('--dataroot_B', required=True, help='path to images of domain-B')
        ...
        parser.add_argument('--netG', type=str, default='noise', help='specify generator architecture [noise | resnet_9blocks | resnet_6blocks | unet_256 | unet_128]')
