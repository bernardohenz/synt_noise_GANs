...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--dataroot_A', required=True, help='path to images of domain-A')
        self.parser.add_argument('--dataroot_B', required=True, help='path to images of domain-B')
        self.parser.add_argument('--dataroot_aligned',help='path to aligned images')
        ...
        self.parser.add_argument('--which_model_netG', type=str, default='noise', help='selects model to use for netG')
